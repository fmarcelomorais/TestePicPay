...
namespace PicPay.Infraestrutura.Migrations
{
    ...
    [Migration("20240524194124_Inicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PicPay.Domain.Models.Transacao", b =>
                {
                    b.HasOne("PicPay.Domain.Models.Usuario", "UsuariosTransacao")
                        .WithOne("Transacoes")
                        .HasForeignKey("PicPay.Domain.Models.Transacao", "UsuarioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("UsuariosTransacao");
                });
