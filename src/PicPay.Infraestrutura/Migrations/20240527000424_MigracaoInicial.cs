    ...
    public partial class MigracaoInicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    NumeroTransacao = table.Column<string>(type: "VARCHAR(32)", nullable: true),
                    DataTransacao = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    StatusTransacao = table.Column<bool>(type: "BIT", nullable: false),
                    ValorTransacao = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                    UsuarioEnviaId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UsuarioRecebeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Transacoes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Transacoes_Usuarios_UsuarioEnviaId",
                        column: x => x.UsuarioEnviaId,
                        principalTable: "Usuarios",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Transacoes_Usuarios_UsuarioRecebeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transacoes_UsuarioEnviaId",
                table: "Transacoes",
                column: "UsuarioEnviaId");

            migrationBuilder.CreateIndex(
                name: "IX_Transacoes_UsuarioRecebeId",
                table: "Transacoes",
